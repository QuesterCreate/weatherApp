...
import code.with.ar.myweatherapp.databinding.ActivityMainBinding
...
//0baf4bc12f8b580d6edd00879210dbc4
class MainActivity : AppCompatActivity() {
    ...
    private fun fetchWeatherData(cityName:String) {
        ...
        val response =
            retrofit.getWeatherData(cityName, "0baf4bc12f8b580d6edd00879210dbc4", "metric")
...
changeImage(condition)
    ...
    private fun changeImage(conditions:String) {
        when(conditions){
            ...
            "Light Rain" ,"Brizzle" , "Moderate Rain" ,"Showers" , "Heavy Rain"->{
